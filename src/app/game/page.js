...
//   // Distractions (pop-up modals already in your code)
...
//     if (audio) {
//       audio.muted = true;
//       audio.loop = true;  // so it repeats automatically
//       audio.play().then(() => {
//         audio.pause();
...
//   // ------------------------------------------------------------------
//   // Distraction Event Listener for Game Page (Polling Backend)
//   // ------------------------------------------------------------------
//   // useEffect(() => {
//   //   const audio = document.getElementById('heavyMetalAudio');
//   //   if (audio) {
...
//       // Dispatch a custom event so the existing distraction listener can handle it
...
//         <audio 
//           id="heavyMetalAudio" 
//           src="/distractions/heavy-metal.mp3" 
//           preload="auto" 
//           loop 
//         />  
  ...
  @keyframes rotate {
    ...
    100% { transform: rotate(360deg); }
      ...
      <div className="min-h-screen bg-gradient-to-b from-blue-900 to-gray-900 text-white p-4">
        ...
        />
        <audio
          id="crowdTalkingAudio"
          src="/distractions/crowd-talking.mp3"
          preload="auto"
          loop
        />
        <audio
          id="classicAudio"
          src="/distractions/classic.mp3"
          preload="auto"
          loop
        />
