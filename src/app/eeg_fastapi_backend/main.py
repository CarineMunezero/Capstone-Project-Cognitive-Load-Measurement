...
# # Distraction Storage
# # --------------------
# distraction_events = []    # Global list to store distraction events
...
#     return {"eeg": last_samples, "cognitive_load": cog_load}

# # ------------- Distraction Endpoints ----------------
# @app.post("/distraction")
# async def post_distraction(request: Request):
#     """
#     Accepts a distraction event in JSON format (e.g., {"type": "HEAVY METAL"})
#     and stores it in the global distraction_events list.
#     """
#     data = await request.json()
#     distraction_events.append(data)
#     return {"status": "Distraction received"}

# @app.get("/distraction")
# def get_distraction():
#     """
#     Returns all stored distraction events and clears the list.
#     """
#     global distraction_events
#     events = distraction_events.copy()
#     distraction_events.clear()
#     return {"distractions": events}
