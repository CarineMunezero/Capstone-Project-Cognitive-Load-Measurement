...
<div class="container">
    ...
    <form id="registration-form">
        ...
        <p style="margin-top: 20px;">
            ...
            <!-- Link to the separate login page -->
            <a href='index.php?page=page4' style="color: #f0a500;">Sign In</a>
        </p>
    </form>
</div>
...
function submitRegistration() {
    ...
    .then(data => {
        if (data.trim() === 'success') {
            // If registration succeeds, go immediately to login.php
            window.location.href = 'index.php?page=page4';
        } else {
   ...
   <!-- Login Page 4 -->
    <!-- CHANGED style so it toggles based on $page -->
    <div id="page4" style="display: <?php echo $page == 'page4' ? 'block' : 'none'; ?>;">
        <h2>Login</h2>
        <form id="login-form">
            <div>
                <label for="username">Username</label>
        ...
        function submitLogin() {
            ...
            .then(data => {
                if (data.trim() === 'success') {
                    // After successful login, go to page5
                    window.location.href = 'index.php?page=page5';
                } else {
    ...
    <!-- Page 5: How the Testing Works -->
    <!-- CHANGED style so it toggles based on $page -->
    <div id="page5" style="display: <?php echo $page == 'page5' ? 'block' : 'none'; ?>;">
        ...
        <button class="next-btn" onclick="nextPage('page5', 'page6')">Start</button>
    </div>
    ...
    <!-- Page 7: Start Game -->
    <div id="page7" style="display: <?php echo $page == 'page7' ? 'block' : 'none'; ?>;">
...
<script>
    ...
    function displayQuestion() {
        ...
        if (questionObj.type === "radio") {
            questionObj.options.forEach((option, index) => {
                ...
                input.name = "answer";
                input.value = option;
                if (index === 0) input.checked = true; // default to first
    ...
    // No changes to existing submitRegistration code
    function submitRegistration() {
